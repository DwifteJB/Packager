...
module.exports = {
    ...
    async execute(client, message, args) {
        const inviteEmbed = new Discord.MessageEmbed()
            ...
            .setDescription(`Packager allows for jailbreak tweak searches within Discord!`)
            .addField('Invite','The invite link can be found [here](https://discord.com/oauth2/authorize?client_id=779761768447737886&scope=bot&permissions=19456) to add it to your server.')
            .addField('Usages', `\`\`\`diff\n+ [[Sileo]]\n+ [[org.coolstar.sileo]]\n+ Hey guys check out [[Sileo]]!\`\`\``)
