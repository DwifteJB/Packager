          ...
          message.channel
            ...
            .then(async collected2 => {
              if (collected.first().content.toLowerCase() == "cancel")
                ...
                const repos = fs.readFileSync("./src/repos.json");
                repos[collected.first().content] = collected2.first().content
                fs.writeFileSync("./src/repos.json");
